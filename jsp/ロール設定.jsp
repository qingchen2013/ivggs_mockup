...
<div id="wrapper">
       ...
       <div class="columns-1" id="content-wrapper">	
		...
		<div id="p_p_id_88_" class="portlet-boundary portlet-boundary_88_  portlet-communities"><a id="p_88"></a>
			<div class="portlet" id="portlet-wrapper-88">	
				<div class="portlet-topper">	
					<span class="portlet-title" style="cursor: move;">	<span><img class="icon" src="./img/common/configuration.png" alt="主数据管理" title="主数据管理" style="background-image: url('/html/icons/.sprite.png'); background-position: 50% -272px; background-repeat: no-repeat; height: 16px; width: 16px;"></span>主数据管理>>ロール設定:</span>	
			 	</div>
							...
							<form action="">
													...
													<table class="taglib-search-iterator">	
                                                        <tr class="iv-search-head-title">	
                                                               <th nowrap class="col-1 " colspan="8">检索条件</th>
                                                        ...
                                                        <tr class="iv-data-detail">  
                                                              ...
                                                              <td class="col-1" colspan="2" valign="middle">
                                                        ...
                                                        <tr class="iv-data-detail">  
                                                              <td class="col-1" colspan="1" valign="middle">
                                                               ...
                                                               <td class="col-1" colspan="1" valign="middle">
                                                                <select class="short-select" selectid="fontType" title="出项">
                                                              ...
                                                              <td class="col-1" colspan="1" valign="middle">
                                                                <select class="short-select" selectid="fontType" title="出项">
                                                                            <option value="P1" selected>ITS</option>
                                                                            <option value="P2">BS</option>
                                                                          </select>
                                                              </td>
                                                              <td class="col-1" colspan="1" valign="middle">
                                                                <select class="short-select" selectid="fontType" title="出项">
                                                                            <option value="P1" selected>MCG</option>
                                                                            <option value="P2">ERP3</option>
                                                                          </select>
                                                              </td>
                                                              <td class="col-1" colspan="2" valign="middle">
                                                              ...
                                                              <td class="col-1" colspan="1" valign="middle">
                                                                <select class="short-select" selectid="fontType" title="出项">
                                                                            <option value="P1" selected>是</option>
													...
													<table>	
                                                                        ...
                                                                        <th nowrap  class="col-1 " colspan="9">审批流程明细</th>
                                                                        </th>  
                                                                    </tr>
                                                                    ...
                                                                    <tr class="iv-data-detail-buttom">
                                                                        <th nowrap align="right" class="col-9 " colspan="9">&nbsp;&nbsp;<a href=""><img src="./img/common/add_article.png"><span>保存修改</span>&nbsp;&nbsp;<a href=""><img src="./img/common/undo.png"><span>放弃修改</span>
							                                                        ...
							                                                        <tr class="iv-data-detail"  onmouseover="this.className = 'iv-data-detail-hover iv-data-detail';" onmouseout="this.className = 'iv-data-detail';"  >	
						                                                               <td class="col-1 iv-date-detail-field"	 colspan="2">工时审批
						                                                               </td>
                                                                              ...
                                                                              <input type="text" class="middle-input-text" value="勤務状態_上海1">
						                                                               </td> 
