						...
						<table class="taglib-search-iterator">	
                            ...
                            <tr class="iv-search-head-detail">	
                                  ...
                                  <td align="left" class="col-5" colspan="2" valign="middle">	
                                      <input type="text" class="short-input-text">	～  <input type="text" class="short-input-text">
                                  </td>
                            ...
                            <tr class="iv-search-head-detail">                       
                                  ...
                                  <td align="left" class="col-2" colspan="2" valign="middle">  
                                      <select class="short-select" selectid="fontType" title="可否换休">
                                         <option value="P1" selected></option>
                                         <option value="P2">可</option>
                                         <option value="P3">不可</option>
                                      </select>  
                                  </td>
                                  <td class="col-4" colspan="1" valign="middle">
                                      截止日
                        ...
                        <br>
  											 <table class="iv-table">	
                                                        ...
                                                        <tr class="iv-search-result-head">	
                                                               ...
                                                               <th nowrap class="col-2 " >休假名称</th>
                                                               <th nowrap class="col-3 " >休假期间</th>
                                                               <th nowrap class="col-4 " >可否换休</th>
                                                               <th nowrap class="col-5 " >截止日</th>
